...
<div class="row">
    <div class="wrapper">
        <div class="aboutuspage col-lg-8 ingress">
            ...
            <h4>Men bakom alla filter och tillgänglighet av handel alla timmar på dygnet växer en farlig trend sig allt
                starkare.
                Genom att öppna upp för fri handel digitalt bidrar vi också med en förstärkt massproduktion och ett merbehov
                som vi
                annars inte skulle identifiera oss med och allt på bekostnad av jordens resuser.</h4>

            <h4>Vi ville i stället utveckla en e-handel med en produkt framtagen på minimal påverkan av jordens resuser,
                som dessutom produceras när konsumenten gör sin beställning, där hundratals artiklar inte existerar för
                merköp och där vi kan stå för vad vi säljer. Då har vi i alla fall gjort det vi kunnat för att minimera
                skövlingen av vår planets resuser och det tycker vi är ett bra steg i e-handelsutvecklingen. Det kom till
                att bli -</h4>
        ...
        <div class="col-lg-4 workspace">
            <div class="process">
                <a href="https://drive.google.com/drive/folders/1OIJNDsnOYmhjXTurSEFdPo97LRlAP8vF" target="_blank"><img
