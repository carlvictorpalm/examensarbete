		...
		<fieldset id="wc-<?php echo esc_attr( $this->id ); ?>-cc-form" class="wc-credit-card-form wc-payment-form" style="background:transparent;">
			...
			<?php if ( $this->inline_cc_form ) { ?>
				<label for="card-element">
					<?php esc_html_e( 'Kredit-eller betalkort', 'woocommerce-gateway-stripe' ); ?>
				</label>
			...
			<?php } else { ?>
				<div class="form-row form-row-wide">
					<label><?php _e( 'Kortnummer', 'woocommerce-gateway-stripe' ); ?> <span class="required">*</span></label>
				...
				<div class="form-row form-row-first">
					<label><?php _e( 'Utgångsdatum', 'woocommerce-gateway-stripe' ); ?> <span class="required">*</span></label>
				...
				<div class="form-row form-row-last">
					<label><?php _e( 'Kortkod (CVC)', 'woocommerce-gateway-stripe' ); ?> <span class="required">*</span></label>
